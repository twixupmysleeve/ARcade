...
protocol ARCadeARViewControllerDelegate:NSObjectProtocol {
    func modelChanged(model:ARCadeModel)
}

class ARCadeARViewController: UIViewController, ARSessionDelegate, MCSessionDelegate, MCNearbyServiceAdvertiserDelegate, MCNearbyServiceBrowserDelegate, ARCoachingOverlayViewDelegate {
    
    weak var delegate: ARCadeARViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        serviceAdvertiser = MCNearbyServiceAdvertiser(peer: myPeerID, discoveryInfo: nil, serviceType: ARCadeARViewController.serviceType)
        serviceAdvertiser.delegate = self
        serviceAdvertiser.startAdvertisingPeer()
        
        serviceBrowser = MCNearbyServiceBrowser(peer: myPeerID, serviceType: ARCadeARViewController.serviceType)
